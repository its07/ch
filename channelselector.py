...
def channels_list():
    ...
    itemlist.append( Item( title="[COLOR azure]cb01_video[/COLOR]"         , channel="cb01_video"           , language="IT"    , category="B,F"   , type="generic"))
    ...
    itemlist.append( Item( title="[COLOR azure]IlGenioDelloStreaming[/COLOR]"      , channel="ilgeniodellostreaming"           , language="IT"    , category="B,F"   , type="generic" ))
...
def get_thumbnail_path(preferred_thumb=""):
    ...
    if preferred_thumb=="":
        ...
        if thumbnail_type=="0":
            WEB_PATH = "https://raw.githubusercontent.com/its07/im/master/posters/"
        elif thumbnail_type=="1":
            WEB_PATH = "https://raw.githubusercontent.com/its07/im/master/banners/"
        elif thumbnail_type=="2":
            WEB_PATH = "https://raw.githubusercontent.com/its07/im/master/squares/"
    else:
        WEB_PATH = "https://raw.githubusercontent.com/its07/im/master/"+preferred_thumb+"/"
